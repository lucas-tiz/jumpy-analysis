function [x,f,err_lim_bool] = forwardDynamicsLcp(obj, q, qd, tau, dt)
    ...
    while err > 1e-6
        ...
        J12 = [1,0,(-1).*l(1).*sin(theta1)+(-1).*l(2).*sin(theta1+theta2)+(-1).* ...
            ...
            -1).*l(4).*sin(theta1+theta2+theta3+theta4+theta5),(-1).*l(2).*sin( ...
            theta1+theta2)+(-1).*l(3).*sin(theta1+theta2+theta3)+(-1).*l(4).* ...
            sin(theta1+theta2+theta3+theta4)+(-1).*l(4).*sin(theta1+theta2+theta3+theta4+theta5),( ...
            -1).*l(3).*sin(theta1+theta2+theta3)+(-1).*l(4).*sin(theta1+theta2+theta3+theta4)+( ...
            -1).*l(4).*sin(theta1+theta2+theta3+theta4+theta5),(-1).*l(4).*sin( ...
            theta1+theta2+theta3+theta4)+(-1).*l(4).*sin(theta1+theta2+theta3+theta4+theta5),( ...
            -1).*l(4).*sin(theta1+theta2+theta3+theta4+theta5);0,1,l(1).*cos( ...
            theta1)+l(2).*cos(theta1+theta2)+l(3).*cos(theta1+theta2+theta3)+l(4).* ...
            cos(theta1+theta2+theta3+theta4)+l(4).*cos(theta1+theta2+theta3+theta4+theta5),l(2).* ...
            cos(theta1+theta2)+l(3).*cos(theta1+theta2+theta3)+l(4).*cos(theta1+theta2+theta3+theta4)+l(4).* ...
            cos(theta1+theta2+theta3+theta4+theta5),l(3).*cos(theta1+theta2+theta3)+l(4).* ...
            cos(theta1+theta2+theta3+theta4)+l(4).*cos(theta1+theta2+theta3+theta4+theta5),l(4).* ...
            cos(theta1+theta2+theta3+theta4)+l(4).*cos(theta1+theta2+theta3+theta4+theta5),l(4).* ...
