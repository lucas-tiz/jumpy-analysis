function plotTrajectory(obj)
    ...
    plot(obj.sim_data.t, obj.sim_data.joints.knee_right.contract_musc, 'Color', co(2,:))
    plot(obj.sim_data.t, obj.sim_data.joints.knee_left.contract_musc, ':', 'Color', co(2,:), 'LineWidth', 1.5)
    plot(obj.sim_data.t, obj.sim_data.joints.knee_right.elong_tendon, 'Color', co(3,:))
    plot(obj.sim_data.t, obj.sim_data.joints.knee_left.elong_tendon, ':', 'Color', co(3,:), 'LineWidth', 1.5)
    xlabel('Time (s)')
    ylabel('Length (cm)')
    ...
    hold on
    grid on
    plot(obj.sim_data.t, obj.sim_data.joints.knee_right.force_mtu, 'Color', co(1,:))
    plot(obj.sim_data.t, obj.sim_data.joints.knee_left.force_mtu, ':', 'Color', co(1,:), 'LineWidth', 1.5)
    xlabel('Time (s)')
    ylabel('Force (N)')
    ...
    plot(obj.sim_data.t, obj.sim_data.joints.hip_right.contract_musc, 'Color', co(2,:))
    plot(obj.sim_data.t, obj.sim_data.joints.hip_left.contract_musc, ':', 'Color', co(2,:), 'LineWidth', 1.5)
    plot(obj.sim_data.t, obj.sim_data.joints.hip_right.elong_tendon, 'Color', co(3,:))
    plot(obj.sim_data.t, obj.sim_data.joints.hip_left.elong_tendon, ':', 'Color', co(3,:), 'LineWidth', 1.5)
    xlabel('Time (s)')
    ylabel('Length (cm)')
    legend('Joint Disp 1', 'Joint Disp 4', 'Muscle Contract 1', 'Muscle Contract 4',...
        'Tendon Stretch 1', 'Tendon Stretch 4', 'Location', 'NorthEast')
    ...
    hold on
    grid on
    plot(obj.sim_data.t, obj.sim_data.joints.hip_right.force_mtu, 'Color', co(1,:))
    plot(obj.sim_data.t, obj.sim_data.joints.hip_left.force_mtu, ':', 'Color', co(1,:), 'LineWidth', 1.5)
    xlabel('Time (s)')
    ylabel('Force (N)')
    legend('Force 1', 'Force 4')
    ylims = get(gca, 'YLim');
...
%     ylim([-50 50])
    ...
    hold on
    grid on
    plot(obj.sim_data.t, obj.sim_data.joints.knee_right.rho_musc)
    plot(obj.sim_data.t, obj.sim_data.joints.hip_right.rho_musc)
    plot(obj.sim_data.t, obj.sim_data.joints.hip_left.rho_musc)
    plot(obj.sim_data.t, obj.sim_data.joints.knee_left.rho_musc)
    ...
    hold on
    grid on
    plot(obj.sim_data.t, obj.sim_data.joints.knee_right.m_musc)
    plot(obj.sim_data.t, obj.sim_data.joints.hip_right.m_musc)
    plot(obj.sim_data.t, obj.sim_data.joints.hip_left.m_musc)
    plot(obj.sim_data.t, obj.sim_data.joints.knee_left.m_musc)
    legend('knee R', 'hip R', 'hip L', 'knee L')
    xlabel('Time (s)')
    ylabel('Mass (kg)')
    ...
    hold on
    grid on
    plot(obj.sim_data.t, obj.sim_data.joints.knee_right.mdot_musc)
    plot(obj.sim_data.t, obj.sim_data.joints.hip_right.mdot_musc)
    plot(obj.sim_data.t, obj.sim_data.joints.hip_left.mdot_musc)
    plot(obj.sim_data.t, obj.sim_data.joints.knee_left.mdot_musc)
    legend('knee R', 'hip R', 'hip L', 'knee L')
    xlabel('Time (s)')
    ...
    hold on
    grid on
    plot(obj.sim_data.t, obj.sim_data.joints.knee_right.vol_musc*1e6)
    plot(obj.sim_data.t, obj.sim_data.joints.hip_right.vol_musc*1e6)
    plot(obj.sim_data.t, obj.sim_data.joints.hip_left.vol_musc*1e6)
    plot(obj.sim_data.t, obj.sim_data.joints.knee_left.vol_musc*1e6)
    legend('knee R', 'hip R', 'hip L', 'knee L')
    xlabel('Time (s)')
    ylabel('Volume (mL)')
