function [x,pos_constraint,err_lim_bool] = forwardDynamicsLcp(robot, q, qd, tau, dt)
    ...
    while err > 1e-6
        ...
        [M, C] = HandC(robot, q_next_est, qd); % M(q)*qdd + C(q,qd) = tau 
        ...
        pos_constraint = footPos(robot, q_next_est);%... % position constraints for robot feet
%             [xA0;
