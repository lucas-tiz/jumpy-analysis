...
%         cam_map % moment arm and linear displacement data
    ...
    methods
        ...
        integrateMuscPres(obj, t_valve, t_max, p_max, robot);
...
%                 num2str(obj.joint_param.slope)]; % NOTE: no rounding
        ...
        %% main method
        function updateJointState(obj, theta0, theta, t_valve, t_max, p_max, robot)
            ...
            obj.integrateMuscPres(t_valve, t_max, p_max, robot); % integrate pressure in time
